            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="manufacturer.toys.label" default="Toys" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="manufacturer.website.label" default="Website" /></td>
